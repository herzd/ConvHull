...
*** definitions
    ...
    + convex hull :: 1. The (unique) minimal convex set containing set X.
		     2. The intersection of all convex sets containing set X.
		     3. The set of all convex combinations of points in set X.
		     4. The union of all simplices with vertices in set X.
    + 
