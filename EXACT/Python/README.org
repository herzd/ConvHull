* Exact implementation of the convex hull method in Python
  In this file I document my work on the exact version of the convex hull method Python-implementation.  Changes on the initial files (~main.py~, and ~chm_exact.py~) will be produced from this file. These will be called ~main_v2.py~ and ~chm_exact_v2.py~.
